...
# Variables Orion #
$SourceHost = 'solarwinds2016.arlaw.com'
$SourceUser = 'loop1'
$SourcePass = 'P@ssw0rdP@ssw0rd'
...
$destinationHost = 'solarwinds2022.arlaw.com'
$DestinationUser = 'loop1'
$DestinationPass = '$NvK6Cp3WF@nw4Dr'
